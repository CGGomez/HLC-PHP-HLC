...
<?php
#Vamos a comprobar que $pepe y $pepa son iguales
if($Pepa == $Pepe){
    echo '<br> Respusta Correcta';  #Si son iguales, se mostrará este mensaje
}else{
    echo '<br> Respuesta Incorrecta'; #En caso contrario a verdadero, se mostrará este mensaje
}
